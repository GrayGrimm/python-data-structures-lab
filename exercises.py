...
def create_awesome_students():
    # your code here
    students = ['odin', 'zeus', 'jupiter']
    awesome_students = [f"{name.capitalize()} is awesome!" for name in students]
...
def filter_foods_with_a():
    # your code here
   foods = ('apple', 'pizza', 'fries', 'banana')
